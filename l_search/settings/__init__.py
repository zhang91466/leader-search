...
default_query_runners = [
    ...
    "l_search.query_runner.mysql",
    "l_search.query_runner.postgresql"
]
...
SYNC_META_CRONTAB = os.environ.get("LSEARCH_SYNC_META_SCHEDULE", "21 * * * *")
...
SOURCE_DB_CONNECTION_URL = {DBObjectType("greenplum").value: {"connect_prefix": "postgresql+psycopg2",
                            ...
                            DBObjectType("mysql").value: {"connect_prefix": "mysql+mysqldb",
                                                          "remark": "?charset=utf8&use_unicode=False"},
