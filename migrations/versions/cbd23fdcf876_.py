...
Revision ID: cbd23fdcf876
Revises: 
Create Date: 2022-03-03 10:59:38.391582
...
def upgrade():
    ...
    op.create_index('table_info_connection_id_table_name_index', 'table_info', ['connection_id', 'table_name'], unique=True)
    ...
    op.create_index('table_detail_table_info_id_column_name_index', 'table_detail', ['table_info_id', 'column_name'], unique=True)
